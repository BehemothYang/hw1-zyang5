...
public class HamiltonApportionmentTest {
    ...
    void apportionReturnsExpectedResultsForProfessorExample() {
        ...
        Map<State, Integer> result =
                HamiltonApportionment.apportion(states, 25);
    ...
    void apportionAllocatesRepresentativesUsingLargestRemainders() {
        ...
        Map<State, Integer> result = HamiltonApportionment.apportion(
    ...
    void apportionRejectsNonpositiveRepresentativeCount() {
        List<State> states = List.of(new State("Alpha", 100));

        IllegalArgumentException exception = assertThrows(
                IllegalArgumentException.class,
                () -> HamiltonApportionment.apportion(states, 0)
        );
    ...
    void apportionRejectsZeroTotalPopulation() {
        ...
        IllegalArgumentException exception = assertThrows(
                IllegalArgumentException.class,
                () -> HamiltonApportionment.apportion(states, 10)
        );
